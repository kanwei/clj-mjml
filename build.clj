...
(defn- pom-template [version]
  [[:description "FIXME: my new library."]
   [:url "https://github.com/clj-mjml/mjml"]
   [:licenses
    [:license
   ...
   [:scm
    [:url "https://github.com/clj-mjml/mjml"]
    [:connection "scm:git:https://github.com/clj-mjml/mjml.git"]
    [:developerConnection "scm:git:ssh:git@github.com:clj-mjml/mjml.git"]
    [:tag (str "v" version)]]])
